function ApplySection() {
  ...
  return (
    <div className="min-h-screen bg-[url('https://ik.imagekit.io/euurqxbuc/uploaded-asset_vYBs-degh')] bg-center bg-no-repeat bg-cover bg-black flex flex-col items-center min-w-scren overflow-x-hidden">
      <h1 className='scroll-m-20 text-4xl tracking-tight lg:text-4xl font-fort text-white flex items-center gap-3 [@media(max-width:530px)]:text-[1.3rem]'>
        <img
          src='https://ik.imagekit.io/euurqxbuc/uploaded-asset_VnDHU6kQr'
          alt=''
          className='w-18 [@media(max-width:530px)]:w-12'
        />
        <p>Apply Right Away!</p>
        <img
          src='https://ik.imagekit.io/euurqxbuc/uploaded-asset_WhfzGlVzm2'
          alt=''
          className='w-18 [@media(max-width:530px)]:w-12'
        />
      </h1>
...
'
      ...
      <div className='flex w-full overflow-visible mt-40 [@media(max-width:703px)]:mt-10 items-center justify-center mx-5 px-5 mb-5 relative'>
        <img
          src='https://ik.imagekit.io/euurqxbuc/uploaded-asset_k_5DRK8sW'
          alt=''
        ...
        <img
          src='https://ik.imagekit.io/euurqxbuc/uploaded-asset_DL1c9u-Qk'
          alt=''
