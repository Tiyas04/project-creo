...
export function FAQHeader() {
  return (
    <div className='flex flex-row items-center justify-center gap-2 sm:gap-4 md:gap-[17px] mb-10 sm:mb-12 md:mb-16 px-2'>
      ...
      >
        <span className='smd:hidden block'>FAQ's</span>
        <span className='smd:block hidden'> Frequently Asked Questions</span>
      </H2>

      {/* Right bolt icon - visible on all screens */}
      <BoltIcon className='object-contain flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-[100px] lg:h-[100px]' />
    </div>
  )
}
